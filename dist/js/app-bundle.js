...
/***/ function(module, exports, __webpack_require__) {
	...
	var _psRactiveRouter = __webpack_require__(7);

	var _viewsAppHtml = __webpack_require__(17);

	var _viewsAppHtml2 = _interopRequireDefault(_viewsAppHtml);

	var _pluginsRouter = __webpack_require__(1);

	var RouterPlugin = _interopRequireWildcard(_pluginsRouter);

	var _configRoutes = __webpack_require__(18);

	// import RouterComponent from './components/layout/router';

	var _configRoutes2 = _interopRequireDefault(_configRoutes);

	var _componentsLayoutSearchUser = __webpack_require__(37);

	// import HomePageComponent from './components/home-page';
	// import UserPageComponent from './components/user-page'

	var _componentsLayoutSearchUser2 = _interopRequireDefault(_componentsLayoutSearchUser);

	var App = _psRactiveRouter.BaseApp.extend({
		el: '#app',
		template: _viewsAppHtml2['default'],
		components: {
			SearchUser: _componentsLayoutSearchUser2['default']
		},
		routesConfiguration: _configRoutes2['default'],
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports.BaseApp = __webpack_require__(8);
	module.exports.BasePage = __webpack_require__(16);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Ractive = __webpack_require__(9),
	    objectAssign = __webpack_require__(10),
	    routerManager = __webpack_require__(11),
	    RouterComponent = __webpack_require__(15);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var pagejs = __webpack_require__(12);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports.extend = function createPageComponent(options) {
		var pageProperties = objectAssign({
			template: '',
			events: {},
			onRequestDone: function onRequestDone() {}
		}, options || {}),
		    _onConfig = function _onConfig() {},
		    pageComponent;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsUserPage = __webpack_require__(21);

	var _componentsUserPage2 = _interopRequireDefault(_componentsUserPage);

	var _modelsUser = __webpack_require__(30);

	var _modelsUser2 = _interopRequireDefault(_modelsUser);

	var routes = {
		'/': function _homeController(context, next) {
			next(null, _componentsHomePage2['default']);
		},
		'/user/:username': function _profileController(context, next) {
			_modelsUser2['default'].findByName(context.params.username).then(function (user) {
				next(null, _componentsUserPage2['default'], {
					user: user
				});
			})['catch'](function (err) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _viewsHomePageHtml = __webpack_require__(20);
	...
	var HomePage = _psRactiveRouter.BasePage.extend({
		name: 'HomePage',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _viewsUserPageHtml = __webpack_require__(22);

	var _viewsUserPageHtml2 = _interopRequireDefault(_viewsUserPageHtml);

	var _userProfileSection = __webpack_require__(23);

	var _userProfileSection2 = _interopRequireDefault(_userProfileSection);

	var _userReposSection = __webpack_require__(25);

	var _userReposSection2 = _interopRequireDefault(_userReposSection);

	var _userNotesSection = __webpack_require__(27);

	var _userNotesSection2 = _interopRequireDefault(_userNotesSection);

	var UserPage = _psRactiveRouter.BasePage.extend({
		template: _viewsUserPageHtml2['default'],
		components: {
			UserProfile: _userProfileSection2['default'],
			Repos: _userReposSection2['default'],
			Notes: _userNotesSection2['default']
		},
		onRequestDone: function onRequestDone(request) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _viewsUserProfileSectionHtml = __webpack_require__(24);

	var _viewsUserProfileSectionHtml2 = _interopRequireDefault(_viewsUserProfileSectionHtml);

	var UserProfileSection = _ractive2['default'].extend({
		isolated: true,
		template: _viewsUserProfileSectionHtml2['default']
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _viewsUserReposSectionHtml = __webpack_require__(26);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _viewsUserNotesAddNoteHtml = __webpack_require__(34);
	...
	var AddNote = _ractive2['default'].extend({
		...
		oninit: function oninit() {
			...
			this.on('createNote', function (rEvent) {
				rEvent.original.preventDefault();
				_this.fire('AddUserNote', rEvent.context.newNote);
				_this.set('newNote', '');
			});
		},
		data: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _pluginsAjax = __webpack_require__(31);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getJson(url) {
		var options = arguments.length <= 1 || arguments[1] === undefined ? { cache: false } : arguments[1];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _viewsUserNotesNotesListHtml = __webpack_require__(36);
	...
	var NotesList = _ractive2['default'].extend({
		...
		oninit: function oninit() {
			...
			this.on('deleteNote', function (rEvent) {
				_this.fire('RemoveUserNote', rEvent.context);
			});
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _viewsLayoutSearchUserHtml = __webpack_require__(38);

	var _viewsLayoutSearchUserHtml2 = _interopRequireDefault(_viewsLayoutSearchUserHtml);

	var _pluginsRouter = __webpack_require__(1);

	var router = _interopRequireWildcard(_pluginsRouter);

	var SearchGithub = _ractive2['default'].extend({
		isolated: true,
		template: _viewsLayoutSearchUserHtml2['default'],

		oninit: function oninit() {
			var _this = this;

			this.on('searchUser', function (rEvent) {
				rEvent.original.preventDefault();
